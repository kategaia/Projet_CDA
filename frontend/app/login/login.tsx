...
export default function LoginPage() {
    ...
    async function handleLogin() {
        ...
        if (!email && email != null || !password && password != null) {
            setAlert({message: "Email ou Mot de passe incorrecte !", type:"error"});
            return;
        }
    ...
    return (
      ...
      <div className={styles.card}>
        ...
        <div className={styles.field}>
          ...
          <a href="/forgot-password" className={styles.forgot}>Mot de passe oublié ?</a>
        </div>
        ...
        <p className={styles.registerText}>
          ...
          <a href="/register" className={styles.registerLink}>S&apos;inscrire</a>
        </p>
